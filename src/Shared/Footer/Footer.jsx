const Footer = () => {
    return (
        <div className="">
            <footer className="footer md:px-36 px-0  p-10 bg-base-200 text-base-content">
                <nav>
            ...
            <footer className="footer md:px-36  px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
